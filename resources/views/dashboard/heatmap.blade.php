        ...
        <div class="card">
            <div class="card-header">
                <div class="col-md-12 row">
                    <div class="col-sm-3">
                        <button class="btn btn-danger" id="toggle-heatmap">Toggle Heatmap</button>
                    </div>
                    <div class="col-sm-3">
                        <button class="btn btn-warning" id="change-gradient">Change gradient</button>
                    </div>
                    <div class="col-sm-3">
                        <button class="btn btn-info" id="change-radius">Change radius</button>
                    </div>
                    <div class="col-sm-3">
                        <button class="btn btn-primary" id="change-opacity">Change opacity</button>
                    </div>
                </div>
            </div>
            <div class="card-body">
...
@section('js')
    <script async
        src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAPRzos358SIFG3ub_Nx8W7oG86ycpiRxw&loading=async&libraries=visualization&callback=initMap">
    </script>
